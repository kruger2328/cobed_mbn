...
def hospital_search(request):
    ...
    if request.method=="GET":
        ...
        try:
            ...
            ventilator_beds=Bed.objects.filter(center__center_name__icontains=hospital)
...
def search_lab(request):
    ...
    if request.method=="GET":
        ...
        try:
            ...
            labs=Lab.objects.all()
            return render(request,'account/serach_lab.html',{'labs':labs,'lab':lab})
        except:
            pass
